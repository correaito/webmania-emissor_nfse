...
<body>
	...
	<div class="panel panel-primary principal" style="margin-top: 65px;margin-left: 15px;margin-right: 15px;">
		<div class="panel-heading"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;&nbsp;Nota Fiscal » Cadastro de Contribuinte</div>
		<div class="panel-body">

       <!--   aqui inicia o formulario de cadastro do contribuinte de serviços -->
			<form id="cadcontrib" method="post">
				...
				<div class="col-xs-12 col-md-12">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<select class="form-control" name="tpessoa" id="tpessoa" autofocus>
								<option></option>
				...
				<div class="col-xs-12 col-md-12">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" name="cnpj" onblur="validar(this);" class="form-control" />						
						</div>
					</div>
				...
				<div class="col-xs-12 col-md-12">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" id="cep" onblur="completa_cep();" name="cep" class="form-control" required />				
						</div>
					</div>
	...
	<div class="modal fade" id="cadcontribsucess" tabindex="-1" role="dialog">
